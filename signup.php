    ...
    <?php
        if(isset($_GET["error"])) {
            if($_GET["error"] == "emptyinput") {
                ...
                echo "<p style='margin-top:35px;text-align:center'>Dette brugernavn er ikke tilgængeligt!</p>";
            }
            else if($_GET["error"] == "invalidemail") {
                echo "<p style='margin-top:35px;text-align:center'>Denne email er ikke tilgængelig!</p>";
            }
            else if($_GET["error"] == "passwordsdontmatch") {
                echo "<p style='margin-top:35px;text-align:center'>Adgangskoderne er ikke det samme!</p>";
            }
            else if($_GET["error"] == "stmtfailed") {
                echo "<p style='margin-top:35px;text-align:center'>Noget gik galt, prøv igen!</p>";
            }
            else if($_GET["error"] == "usernametaken") {
                echo "<p style='margin-top:35px;text-align:center'>Brugernavnet er allerede i brug!</p>";
            }
            else if($_GET["error"] == "none") {
                echo "<p style='margin-top:35px;text-align:center'>Du har nu tilmeldt dig!</p>";
            }
        }
    ?>
