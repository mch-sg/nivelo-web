...
<header id="header" class="head">
    <a class="h-logo pro" href="/" style="font-size: 18px; transition: 0.1s ease;">
  ...
  <ul class="nav_links">
    <?php
        if(isset($_SESSION["useruid"])){
            ...
            echo "<li><a class='pro nlink' style='vertical-align: middle;' href='/invite'>Opret nyt rum</a></li>";
            echo "<li><a class='pro nlink' style='vertical-align: middle;' href='/chat_room_s'>Chatrum</a></li>";
            ...
            echo "<li><a class='pro nlink' style='vertical-align: middle;' href='/profile'>Profil</a> </div>";
            ...
            echo "<li id='brd2' class='brd' style='vertical-align: middle;text-align: center;border-left: 1px solid var(--borderclr); height: 35px; margin: 0 0 0 20px;'></li>";
            echo "<li><a class='pro nlink' style='vertical-align: middle;' href='/login'>Log på</a></li>";
            echo "<li><a class='modal-btn-header nlink' href='/signup' style='vertical-align: middle;'>Tilmeld</a></li> </div>";
