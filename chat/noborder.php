...
<header id="header" class="head" style="height:75px;background:#101010">
...
if(count($rows) > 0 && $host != 'chat.nivelo.eu/') {
    foreach($rows as $row) {
            ...
            if($userPrivilege === "admin" && $userCompany !== "") {
                echo "<div class='chatmsg' style='line-height: 1.5;padding: 0px 30px 5px 30px;'><a style='color: $userColor; font-weight:300;pointer-events: none;'>".$row["user_id"]. "<i class='fa-regular fa-badge-check' style='font-size: 14px;margin-left:5px;margin-right: 3px;'></i><a style='margin-right: 5px;padding: 2px 8px;background: #212121;color: #8f8f8f;font-size:15px;font-weight:300;pointer-events: none;margin-left: 5px;border-radius: 5px;'>$userCompany</a></a> " ."<a style='opacity:0.15;pointer-events: none;font-weight:200'>" . $date->format('d/m'). "</a><br> " . " <div style='display: inline-grid;margin-bottom: 15px;'>" . $msg. "</div><br></div>";
            } 
            else if($userPrivilege === "moderator" && $userCompany !== "") {
                echo "<div class='chatmsg' style='line-height: 1.5;padding: 0px 30px 5px 30px;'><a style='color: $userColor; font-weight:300;pointer-events: none;'>".$row["user_id"]. "<i class='fa-duotone fa-shield-check' style='font-size: 14px;margin-left:5px;margin-right: 3px;'></i><a style='margin-right: 5px;padding: 2px 8px;background: #212121;color: #8f8f8f;font-size:15px;font-weight:300;pointer-events: none;margin-left: 5px;border-radius: 5px;'>$userCompany</a></a> " ."<a style='opacity:0.15;pointer-events: none;font-weight:200'>" . $date->format('d/m'). "</a><br> " . " <div style='display: inline-grid;margin-bottom: 15px;'>" . $msg. "</div><br></div>";
            } 
            else if($userPrivilege === "vip" && $userCompany !== "") {
                echo "<div class='chatmsg' style='line-height: 1.5;padding: 0px 30px 5px 30px;'><a style='color: $userColor; font-weight:300;pointer-events: none;'>".$row["user_id"]. "<i class='fa-solid fa-asterisk' style='font-size: 14px;margin-left:5px;margin-right: 3px;'></i><a style='margin-right: 5px;padding: 2px 8px;background: #212121;color: #8f8f8f;font-size:15px;font-weight:300;pointer-events: none;margin-left: 5px;border-radius: 5px;'>$userCompany</a></a> " ."<a style='opacity:0.15;pointer-events: none;font-weight:200'>" . $date->format('d/m'). "</a><br> " . " <div style='display: inline-grid;margin-bottom: 15px;'>" . $msg. "</div><br></div>";
            } 
            
            else if ($userCompany !== "") {
                // !
                echo "<div class='chatmsg' style='line-height: 1.5;padding: 0px 30px 5px 30px;'><a style='color: $userColor; font-weight:300;pointer-events: none;'>".$row["user_id"]. "  <a style='margin-right: 5px;padding: 2px 8px;background: #212121;color: #8f8f8f;font-size:15px;font-weight:300;pointer-events: none;margin-left: 5px;border-radius: 5px;'>$userCompany</a></a> " ."<a style='opacity:0.15;pointer-events: none;font-weight:200'>" . $date->format('d/m'). "</a><br> " . " <div style='display: inline-grid;margin-bottom: 15px;'>" . $msg. "</div><br></div>";
            }
            ...
            // ? med FIRMA
            if($userPrivilege === "admin" && $userCompany == "") {
                echo "<div class='chatmsg' style='line-height: 1.5;padding: 0px 30px 5px 30px;'><a style='color: $userColor; font-weight:300;pointer-events: none;'>".$row["user_id"]. "<i class='fa-regular fa-badge-check' style='font-size: 14px;margin-left:5px;margin-right: 3px;'></i></a> " ."<a style='opacity:0.15;pointer-events: none;font-weight:200'>" . $date->format('d/m'). "</a><br> " . " <div style='display: inline-grid;margin-bottom: 15px;'>" . $msg. "</div><br></div>";
            } 
            else if($userPrivilege === "moderator" && $userCompany == "") {
                echo "<div class='chatmsg' style='line-height: 1.5;padding: 0px 30px 5px 30px;'><a style='color: $userColor; font-weight:300;pointer-events: none;'>".$row["user_id"]. "<i class='fa-duotone fa-shield-check' style='font-size: 14px;margin-left:5px;margin-right: 3px;'></i></a> " ."<a style='opacity:0.15;pointer-events: none;font-weight:200'>" . $date->format('d/m'). "</a><br> " . " <div style='display: inline-grid;margin-bottom: 15px;'>" . $msg. "</div><br></div>";
            } 
            else if($userPrivilege === "vip" && $userCompany == "") {
                echo "<div class='chatmsg' style='line-height: 1.5;padding: 0px 30px 5px 30px;'><a style='color: $userColor; font-weight:300;pointer-events: none;'>".$row["user_id"]. "<i class='fa-solid fa-asterisk' style='font-size: 14px;margin-left:5px;margin-right: 3px;'></i></a> " ."<a style='opacity:0.15;pointer-events: none;font-weight:200'>" . $date->format('d/m'). "</a><br> " . " <div style='display: inline-grid;margin-bottom: 15px;'>" . $msg. "</div><br></div>";
            } 
            
            else if ($userCompany == "") {
                // ?
                echo "<div class='chatmsg' style='line-height: 1.5;padding: 0px 30px 5px 30px;'><a style='color: $userColor; font-weight:300;pointer-events: none;'>".$row["user_id"]. "</a> " ."<a style='opacity:0.15;pointer-events: none;font-weight:200'>" . $date->format('d/m'). "</a><br> " . " <div style='display: inline-grid;margin-bottom: 15px;'>" . $msg. "</div><br></div>";
            }
    }
